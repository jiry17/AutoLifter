...
Program * ObservationalEquivalenceSolver::synthesisFromExample(const std::vector<std::pair<Example *, Example *> > &example_list) {
...
std::vector<Program *> ObservationalEquivalenceSolver::synthesis() {
    int turn_num = 0;
