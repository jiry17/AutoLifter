...
#define BuildDACTask(name, example_space, external, extra) \
    auto paradigm = new DivideAndConquerParadigm(); \
    auto task_types = paradigm->getTaskTypes();      \
    auto* task = benchmark::defaultBuilder("dac", task_types[0], name, semantics, example_space, external, extra); \
    auto source_path = config::KSourcePath + "resource/dataset/dac/" + name + ".cpp"; \
    return {paradigm, {task}, source_path, {}}

#define BuildDefaultDACTask(name) \
    auto config = defaultExampleConfig(); \
    BuildDACTask(name, config, {}, {})
...
namespace {
    namespace pldi17 {
        ...
        BenchmarkInfo averageBuilder() {
            ...
            BuildDACTask("average", c, {}, extra_list);
        }
        ...
        BenchmarkInfo atoiBuilder() {
            ...
            c.int_max = 9;
            c.max_length = 3;
            BuildDACTask("atoi", c, {}, extra_list);
        }
        ...
        BenchmarkInfo lineSightBuilder() {
            ...
            BuildDefaultDACTask("line_sight");
        }
    ...
    namespace pldi21 {
        ...
        BenchmarkInfo maxSumBetweenOnesBuilder() {
            ...
            c.int_min = 0;
            c.int_max = 3;
            BuildDACTask("max_sum_between_ones", c, {}, {});
        }
        ...
        BenchmarkInfo maxDistanceBetweenZerosBuilder() {
            ...
            c.int_min = 0;
            c.int_max = 1;
            BuildDACTask("max_dist_between_zeros", c, {}, {});
        }
        ...
        BenchmarkInfo largestPeakBuilder() {
            ...
            BuildDefaultDACTask("largest_peak");
        }
        ...
        BenchmarkInfo longestEven0starBuilder() {
            ...
            BuildDACTask("longest00s", c, {}, { is_even_info });
        }
        ...
        BenchmarkInfo longestOdd10starBuilder() {
            ...
            c.max_length = 15;
            c.init_size *= 50;
            BuildDACTask("longest_odd10s", c, {}, { is_even_info });
        }
    }
    ...
    namespace extra {
        ...
        BenchmarkInfo mppBuilder() {
            ...
            c.int_min = -3;
            c.int_max = 3;
            BuildDACTask("mpp", c, {}, { semantics::getSemanticsFromName("*") });
        }
        ...
        BenchmarkInfo mtpBuilder() {
            ...
            c.int_min = -3;
            c.int_max = 3;
            BuildDACTask("mtp", c, {}, { semantics::getSemanticsFromName("*") });
        }
        ...
        BenchmarkInfo mspBuilder() {
            ...
            c.int_min = -3;
            c.int_max = 3;
            BuildDACTask("msp", c, {}, { semantics::getSemanticsFromName("*") });
        }
        ...
        BenchmarkInfo max1sPBuilder() {
            ...
            c.int_min = 0;
            c.int_max = 1;
            BuildDACTask("max_1s_p", c, { new AnonymousSemantics(max_1s_semantics, {TLIST}, TINT, "max_1s") }, {});
        }
    }
...
#define DefaultRegister(name) Register(#name, name)
    ...
    std::map<std::string, std::function<BenchmarkInfo()>> benchmark_map = {
            ...
            Register("max_1s_p", max1sP)
    };
}

BenchmarkInfo benchmark::getDivideAndConquer(const std::string &name) {
