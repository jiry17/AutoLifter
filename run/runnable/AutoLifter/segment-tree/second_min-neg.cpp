...
void apply(int pos, int a) {
    result res = info[pos];
    tag[pos] = tag[pos]?0:1;
    info[pos] = (result){(res.x2)*(-1),(res.x3)*(-1),(res.x0)*(-1),(res.x1)*(-1)};
}
...
void init(int pos, int l, int r) {
    tag[pos] = 0;
    if (l == r) {
        int a = w[l]; info[pos] = (result){1000000000,a,1000000000,a};
        return;
    }
    int mid = l + r >> 1;
    init(pos * 2, l, mid);
    ...
    info[pos] = (result){((rres.x0)<=(lres.x1))?(rres.x0):(((lres.x0)<=(rres.x1))?(lres.x0):(((rres.x1)<=(lres.x1))?(lres.x1):(rres.x1))),((rres.x1)<=(lres.x1))?(rres.x1):(lres.x1),(((rres.x3)<=(lres.x2))&&((lres.x2)!=(1000000000)))?(lres.x2):((((rres.x2)!=(1000000000))&&((lres.x3)<=(rres.x2)))?(rres.x2):(((lres.x3)<=(rres.x3))?(lres.x3):(rres.x3))),((rres.x3)<=(lres.x3))?(lres.x3):(rres.x3)};
}
...
void query(int pos, int l, int r, int ul, int ur) {
    ...
    if (l >= ul && r <= ur) {
        if (is_empty) {
            ...
            query_res = (result){((rres.x0)<=(lres.x1))?(rres.x0):(((lres.x0)<=(rres.x1))?(lres.x0):(((rres.x1)<=(lres.x1))?(lres.x1):(rres.x1))),((rres.x1)<=(lres.x1))?(rres.x1):(lres.x1),(((rres.x3)<=(lres.x2))&&((lres.x2)!=(1000000000)))?(lres.x2):((((rres.x2)!=(1000000000))&&((lres.x3)<=(rres.x2)))?(rres.x2):(((lres.x3)<=(rres.x3))?(lres.x3):(rres.x3))),((rres.x3)<=(lres.x3))?(lres.x3):(rres.x3)};
        }
        return;
    }
    int mid = l + r >> 1; pushdown(pos);
