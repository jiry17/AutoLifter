...
result mergeRes(int a, const result& lres, const result& rres, int lsize, int rsize) {
    if (lsize) {
        if (rsize) {
            return (result){(((((lres.x0)<(((a)+(rres.x2))+(-1)))&&((lres.x2)<(rres.x2)))&&((((a)+(rres.x2))+(-1))<=(((lres.x1)+(rres.x1))+(1))))&&((rres.x1)<(((a)+(rres.x2))+(-1))))?(((a)+(rres.x2))+(-1)):((((((rres.x0)<=(((a)+(lres.x2))+(-1)))&&((lres.x1)<(((a)+(lres.x2))+(-1))))&&((rres.x2)<=(lres.x2)))&&((((a)+(lres.x2))+(-1))<=(((lres.x1)+(rres.x1))+(1))))?(((a)+(lres.x2))+(-1)):((((((lres.x1)+(rres.x1))+(1))<=(((a)+(lres.x2))+(-1)))||((((lres.x1)+(rres.x1))+(1))<=(((a)+(rres.x2))+(-1))))?(((lres.x1)+(rres.x1))+(1)):(((rres.x0)<=(lres.x0))?(lres.x0):(rres.x0)))),((lres.x1)+(rres.x1))+(1),((rres.x2)<=(lres.x2))?(lres.x2):(rres.x2)};
        } else {
