...
void init(int pos, int l, int r) {
    ...
    info[pos] = (result){((lres.x0)<=(rres.x1))?(lres.x0):(((rres.x0)<=(lres.x1))?(rres.x0):(((rres.x1)<=(lres.x1))?(lres.x1):(rres.x1))),((rres.x1)<=(lres.x1))?(rres.x1):(lres.x1),(((rres.x2)<(rres.x3))&&((lres.x3)<=(rres.x2)))?(rres.x2):(((((rres.x3)<(lres.x3))&&((lres.x2)!=(1000000000)))&&((rres.x3)<=(lres.x2)))?(lres.x2):(((((lres.x3)<=(rres.x3))&&((rres.x2)<=(lres.x3)))||(((rres.x2)==(1000000000))&&((lres.x3)<=(rres.x3))))?(lres.x3):(rres.x3))),((rres.x3)<=(lres.x3))?(lres.x3):(rres.x3)};
}
