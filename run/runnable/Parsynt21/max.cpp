...
#pragma omp taskwait
        result _s1;
        _s1.result1 = std::max($L5.result1, $R5.result1);
        return _s1;
    }
}
int main(){
...
//  SUCCESS  Parsed /root/parsynt/inputs/AutoLifter/max.minic.
//  SUCCESS  Equation system: 
// // --- Lifted function ---
// _s1 = { result1 = 0; }for(x in a){
//                         _s1 = {
//                           result1 = max (x, _s1.result1);
//                         }
//                         }
//                         return _s1;
// //--- Splitting predicate: (empty)
// //--- Join function ---
// join($L,$R) = { result1 = max ($R.result1, $L.result1);
// }
